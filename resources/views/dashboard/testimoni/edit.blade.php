...
@section('container')
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Ubah Data Testimoni</strong></h1>

            <div class="row">
                <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
                    <div class="card flex-fill w-100 p-3">
                        <h5 class="card-title mb-3">Ubah Data</h5>
                        <form action="/dashboard/beranda1/{{ $testimoni->slug }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('nama')
                                  is-invalid
                              @enderror" id="nama" name="nama" placeholder="Masukkan Nama TK" value="{{ old('nama', $testimoni->nama) }}" required>
                              @error('nama')
                          ...
                          <input type="hidden" class="form-control" id="slug" name="slug" value="{{ old('slug', $testimoni->slug) }}" required>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                is-invalid
                                @enderror" id="deskripsi" name="deskripsi" rows="4" placeholder="Masukkan Deskripsi" required>{{ old('deskripsi', $testimoni->deskripsi) }}</textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback">
                                  {{ $message }}
                                </div>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if ($testimoni->image)
                                <img src="{{ asset('storage/' . $testimoni->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                @else
