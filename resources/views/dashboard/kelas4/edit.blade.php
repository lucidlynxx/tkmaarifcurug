...
@section('container')
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Ubah Jadwal Kelas (Jum'at)</strong></h1>

            <div class="row">
                <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
                    <div class="card flex-fill w-100 p-3">
                        <h5 class="card-title mb-3">UBAH JADWAL</h5>
                        <form action="/dashboard/kelas4/{{ $jumat->slug }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('waktu')
                                  is-invalid
                              @enderror" id="waktu" name="waktu" placeholder="Masukkan Judul" value="{{ old('waktu', $jumat->waktu) }}" required>
                              @error('waktu')
                          ...
                          <input type="hidden" class="form-control" id="slug" name="slug" value="{{ old('slug', $jumat->slug) }}" required>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('kegiatan')
                                  is-invalid
                              @enderror" id="kegiatan" name="kegiatan" placeholder="Masukkan Judul" value="{{ old('kegiatan', $jumat->kegiatan) }}" required>
                              @error('kegiatan')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
