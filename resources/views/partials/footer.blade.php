    ...
    <div class="row pt-5">
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        ...
        <div class="d-flex flex-column justify-content-start">
          <a class="text-white mb-2" href="#beranda"
            ><i class="fa fa-angle-right mr-2"></i>Beranda</a
          >
          <a class="text-white mb-2" href="#tentang-kami"
            ><i class="fa fa-angle-right mr-2"></i>Tentang Kami</a
          >
          <a class="text-white mb-2" href="#kelas"
            ><i class="fa fa-angle-right mr-2"></i>Kelas</a
          >
          <a class="text-white mb-2" href="#guru"
            ><i class="fa fa-angle-right mr-2"></i>Guru</a
          >
          <a class="text-white mb-2" href="#testimoni"
            ><i class="fa fa-angle-right mr-2"></i>Testimoni</a
          >
          <a class="text-white mb-2" href="#acara"
            ><i class="fa fa-angle-right mr-2"></i>Acara</a
          >
        </div>
      </div>
      @else
      <div class="col-lg-4 col-md-6 mb-5">
        ...
        <div class="d-flex flex-column justify-content-start">
          ...
          <a class="text-white mb-2" href="/guru"
            ><i class="fa fa-angle-right mr-2"></i>Guru</a
          >
          <a class="text-white mb-2" href="/galeri"
            ><i class="fa fa-angle-right mr-2"></i>Galeri</a
          >
          <a class="text-white mb-2" href="/acara"
            ><i class="fa fa-angle-right mr-2"></i>Acara</a
          >
          <a class="text-white mb-2" href="/kontak"
